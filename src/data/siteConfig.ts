export const siteConfig = {
  ...
  bio: [
    ...
    "With deep expertise in modern web technologies and an eye for design, we deliver sites that load fast, look stunning, and convert browsers into buyers.",
  ],
  email: 'hello@macancela.tech',
  location: 'United States',
  ctaText: 'Start Your Project',
  ctaSubtext: 'Let\u2019s build something beautiful together.',
}
