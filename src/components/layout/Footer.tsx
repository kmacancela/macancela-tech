...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-sand/50 py-16">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-6 sm:grid-cols-3">
        ...
        <div>
          ...
          {/* Eco note */}
          <div className="mt-4 flex items-center gap-2 text-leaf">
            ...
            <span className="text-xs font-medium">Built with the planet in mind</span>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-6 text-xs tracking-wide text-ink-muted">
            &copy; {new Date().getFullYear()} Macancela Tech
          </p>
        </div>
      </div>
    </footer>
